        ...
        >
            ...
            >
                ...
                <img 
                    ...
                    class="pointer-events-none h-[100%] w-[100%] object-cover" 
...
<script setup>
  ...
  const props = defineProps({ category: String, menus: Array })
  const { menus, category } = toRefs(props)
